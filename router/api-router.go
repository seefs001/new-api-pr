...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.GET("/invitation/preview", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.GetUserInvitationPreview)
			userRoute.POST("/invitation/claim", middleware.CriticalRateLimit(), middleware.DisableCache(), anonymousRequestBodyLimit, middleware.TurnstileCheck(), controller.ClaimUserInvitation)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.POST("/invitations", controller.AdminCreateUserInvitation)
				adminRoute.GET("/:id/invitations", controller.AdminListUserInvitations)
				adminRoute.PUT("/:id/invitation", controller.AdminUpdateUserInvitation)
				adminRoute.POST("/:id/invitation/reissue", controller.AdminReissueUserInvitation)
				adminRoute.POST("/:id/invitation/revoke", controller.AdminRevokeUserInvitation)
