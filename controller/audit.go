...
var auditContentTemplates = map[string]string{
	...
	"user.invitation_create":       "Created invitation ${invitation_id} for pending user ${target_user_id}",
	"user.invitation_update":       "Updated invitation ${invitation_id} for pending user ${target_user_id}",
	"user.invitation_reissue":      "Reissued invitation ${invitation_id} for pending user ${target_user_id}",
	"user.invitation_revoke":       "Revoked invitation ${invitation_id} for pending user ${target_user_id}",
	"user.invitation_claim":        "Claimed invitation ${invitation_id}",
	"user.invitation_claim_failed": "Rejected invitation claim (${reason})",
