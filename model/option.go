...
func InitOptionMap() {
	...
	common.OptionMap["SelfUseRootAutoTopUpEnabled"] = strconv.FormatBool(operation_setting.SelfUseRootAutoTopUpEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "SelfUseRootAutoTopUpEnabled":
			operation_setting.SelfUseRootAutoTopUpEnabled = boolValue
