  ...
  return (
    <>
      <Dialog
        ...
        description={`${props.user?.username || '-'} (ID: ${
          props.user?.id || '-'
        })`}
            ...
            columns={[
              ...
              },
              {
                ...
                cell: (record) => {
                  ...
                  let nextReset = '-'
                  if (isActive && (sub.next_reset_time || 0) > 0) {
                    nextReset = formatTimestamp(sub.next_reset_time || 0)
                  } else if (isActive) {
                    nextReset = t('No Reset')
                  }
