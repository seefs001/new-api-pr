...
type UserSetting struct {
	...
	ModelRouteRules                  []UserModelRouteRule `json:"model_route_rules,omitempty"`                    // ModelRouteRules 用户级模型路由规则
}

type UserModelRouteRule struct {
	...
	Targets      []UserModelRouteTarget `json:"targets,omitempty"`
	Strategy     string                 `json:"strategy,omitempty"`
}

type UserModelRouteTarget struct {
